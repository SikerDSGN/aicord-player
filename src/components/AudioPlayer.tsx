...
import { Play, Pause, SkipBack, SkipForward, Volume2, Shuffle, Repeat, Repeat1, ChevronUp, ChevronDown } from "lucide-react";
...
export function AudioPlayer() {
  ...
  return (
    <div className={`fixed bottom-0 left-0 right-0 z-20 border-t border-border/50 bg-gradient-card backdrop-blur-lg shadow-elevated transition-all duration-300 ${
      ...
      <div className="container px-4 h-full flex flex-col">
        ...
        <div className="flex justify-center py-1">
          <Button
            ...
            className="h-6 w-12 hover:bg-muted/50"
          >
        ...
        {!isExpanded && (
          <div className="flex items-center gap-4 flex-1">
            ...
            >
              {currentSong.cover_url && (
                <img
                  ...
                  className="h-12 w-12 rounded-lg object-cover shadow-glow-soft"
                />
              )}
            ...
            <div className="flex items-center gap-2">
              ...
              <Button size="sm" onClick={togglePlay} className="h-9 w-9 rounded-full bg-gradient-primary shadow-glow-soft hover:shadow-glow hover:scale-110 transition-smooth">
            ...
            >
              {currentSong.cover_url && (
                <img
                  src={currentSong.cover_url}
                  alt={currentSong.title}
                  className="h-16 w-16 rounded-lg object-cover shadow-glow-soft hover-scale"
                />
              )}
