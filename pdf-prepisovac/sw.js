const CACHE='pdf-prepisovac-shell-v1';
const SHELL=['./app.html','./index.html','./zoom.js','./live-preview.js','./mobile-ui.js','./scan-stack.js','./pro-edit.js','./pwa-install.js','./library.js','./manifest.webmanifest','./icon.svg'];
